<html>
    <head>
        ...
        <title>CODEV - Comprobante N° {{$data['numeroCuota']->numero_cuota}}</title>
        <style>
            *{
                margin: 4px;
                padding: 0;
    ...
    <body>
        ...
        <div id="row" style="border: 0.5px solid; padding: 10px;border-radius: 15px;">
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center;font-size: 9px;">
                        <div id="txtDireccion">
                            ...
                            <b style="color: red">{{$data['numeroCuota']->numero_cuota}}</b><br>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table style="font-size: 9px;width: 100%">
                <tr>
                    <td><b>RECIBÍ DE: </b></td>
                    <td colspan="3"><div id="txtDireccion">{{$data['customer']->apellidos .' '.$data['customer']->nombres }}</div></td>
                </tr>
                <tr>
                    <td><b>RUC/C.I: </b></td>
                    <td><div id="txtRuc">{{$data['customer']->numero_documento}}</div></td>
                    <td><b>FECHA: </b></td>
                    <td><div id="txtTelefono">{{$data['numeroCuota']->date_pay}}</div></td>
                </tr>
                <tr>
                    <td><b>N° CUOTA </b></td>
                    <td><div id="txtRuc">{{$data['numeroCuota']->numero_cuota}}</div></td>
                    <td><b>HORA: </b></td>
                    <td><div id="txtTelefono">{{$data['numeroCuota']->hour_pay}}</div></td>
                </tr>
            </table>
        </div>
        <table style="width: 100%;" class="table">
            ...
            <tbody style="font-size: 10px;">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">$ {{$data['numeroCuota']->valor_cuota + $data['gastosCobranza']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">$ {{$data['gastosCobranza']}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">$ {{$data['numeroCuota']->valor_cuota + $data['numeroCuota']->interes_mora + $data['numeroCuota']->faltante_anterior_cuota - $data['numeroCuota']->saldo_anterior_cuota +$data['gastosCobranza']}}</td>
                </tr>
                <tr>
                    <td style="text-align: right;">Valor Pagado</td>
                    <td style="text-align: center;">$ {{$data['numeroCuota']->valor_final}}</td>
                </tr>
