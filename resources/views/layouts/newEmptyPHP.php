...
<html lang="en">
    <head>
        ...
        <title>Ada | Nifty</title>
        <!--STYLESHEET-->
        <!--=================================================-->
        <!--Open Sans Font [ OPTIONAL ]-->
        <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css'>
        <!--Bootstrap Stylesheet [ REQUIRED ]-->
        <link href="nitify\css\bootstrap.min.css" rel="stylesheet">
        <!--Nifty Stylesheet [ REQUIRED ]-->
        <link href="nitify\css\nifty.min.css" rel="stylesheet">
        <!--Nifty Premium Icon [ DEMONSTRATION ]-->
        <link href="nitify\css\demo\nifty-demo-icons.min.css" rel="stylesheet">
        <!--=================================================-->
        <!--Pace - Page Load Progress Par [OPTIONAL]-->
        <link href="pluginsnitify\pace\pace.min.css" rel="stylesheet">
        <script src="pluginsnitify\pace\pace.min.js"></script>
        <!--=================================================-->
    </head>
    <body>
        <div id="container" class="effect aside-float aside-bright mainnav-lg">
                    ...
                    <div class="navbar-header">
                        <a href="index.html" class="navbar-brand">
                            ...
                            <div class="brand-title">
                                <span class="brand-text">ADA</span>
                            </div>
                        </a>
                    </div>
                    <!--================================-->
                                ...
                                <div class="custom-search-form">
                                    ...
                                    <form>
                                        <div class="search-container collapse" id="nav-searchbox">
                                            <input id="search-input" type="text" class="form-control" placeholder="Busqueda...">
                                        </div>
                                    </form>
                                </div>
                            </li>
            ...
            <footer id="footer">
                ...
                <div class="hide-fixed pull-right pad-rgt">
                    500 MB de <strong>1 TB</strong> Sistemas a Medida.
                </div>
                <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
                <!-- Remove the class "show-fixed" and "hide-fixed" to make the content always appears. -->
                <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
                <p class="pad-lft">&#0169; 2015 - {{date('Y')}} John Tello</p>
            </footer>
            <!--===================================================-->
            <!-- END FOOTER -->
            <!-- SCROLL PAGE BUTTON -->
        ...
        <!--=================================================-->
        <!--jQuery [ REQUIRED ]-->
        <script src="nitify\js\jquery.min.js"></script>
        <!--BootstrapJS [ RECOMMENDED ]-->
        <script src="nitify\js\bootstrap.min.js"></script>
        <!--NiftyJS [ RECOMMENDED ]-->
        <script src="nitify\js\nifty.min.js"></script>
        <!--=================================================-->
        <!--Flot Chart [ OPTIONAL ]-->
        <script src="pluginsnitify\flot-charts\jquery.flot.min.js"></script>
        <script src="pluginsnitify\flot-charts\jquery.flot.resize.min.js"></script>
        <script src="pluginsnitify\flot-charts\jquery.flot.tooltip.min.js"></script>
        <!--Sparkline [ OPTIONAL ]-->
        <script src="pluginsnitify\sparkline\jquery.sparkline.min.js"></script>
    </body>
</html>
