        ...
        <div>
            <div class="col-3 mt-2 mb-2">
                <button wire:click="abrirModal(0)" type="button" data-bs-toggle="modal" data-bs-target="#modalGeneral"
                    class="btn btn-block btn-default btn-flat"><i class="fa fa-plus"></i><b> Nuevos Ajustes </b></button>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><b>Ajustes</b></h3>
                                        ...
                                        <tr class="text-center">
                                            <td>
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ URL::to('gastos/tcket/' . $ajus->id) }}"
                                                    title="Tabla de Amortización">
                                                    <i class="far fa-file-pdf"></i>
                                                </a>
                                            </td>
                                            <td>{{ $ajus->code }}</td>
                                            <td>{{ $ajus->customer_name }}</td>
                                            <td>{{ $ajus->type_transaction_name }}</td>
                                            <td>{{ $ajus->observation }}</td>
                                            <td>{{ $ajus->saldo_general }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        <div wire:ignore.self class="modal fade" id="modalGeneral" style="display: none;" aria-hidden="true"
            ...
            <div class="modal-dialog modal-dialog">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="storeAjustes">
