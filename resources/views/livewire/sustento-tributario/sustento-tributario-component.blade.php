        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><b>Sustento Tributario</b></h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-head-fixed text-nowrap table-hover" style="font-size: 15px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">{{ $sustento->id }}</td>
                                <td class="text-center"><b>{{ $sustento->codigo_tributario }}</b></td>
                                <td class="text-center">{{ $sustento->nombre }}</td>
                                <td class="text-center">
                                    @if ($sustento->credito_tributario)
                                ...
                                <td class="text-center">
                                    ...
                                    <small class="badge bg-primary"
                                        wire:click="cambioEstado({{ $sustento->id }})"></i>Activo</small>
                                    @else
                                    <small class="badge bg-danger"
                                        wire:click="cambioEstado({{ $sustento->id }})"></i>Desactivado</small>
                                    @endif
                                </td>
                                <td class="text-center">
                                    <button wire:click="editarTipoComprobante({{ $sustento->id }})" type="button"
                                        data-bs-toggle="modal" data-bs-target="#modalGeneral" type="button"
                                        class="btn btn-outline-primary btn-xs" title="Editar"><i
                                            class="fa fa-pen"></i>
                                    </button>
                                    <!-- <button wire:click="borrarImpuestos({{ $sustento->id }})"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Sustento Tributario</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-2 mt-4 ms-4">
                                <input class="form-check-input" type="checkbox" wire:model="credito_tributario">
                                <label class="form-check-label">Credito Tributario</label>
                            </div>
                        </div>
                    </div>
