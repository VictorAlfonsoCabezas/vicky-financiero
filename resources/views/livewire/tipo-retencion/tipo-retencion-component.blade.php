        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><b>Tipos de Retenciones</b></h3>
                    ...
                    <table class="table table-head-fixed text-nowrap table-hover" style="font-size: 15px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $tipo->name }}</td>
                                ...
                                <td class="text-center">
                                    <button wire:click="editarImpuestos({{ $tipo->id }})" type="button"
