                    ...
                    <div class="row col col-sm-12">
                        <section class="col col-sm-12">
                            <div class="form-group">
                                <label>Detallar la razón de la Anulación</label>
                                <textarea id="razon_retiro" name="razon_retiro" class="form-control text-uppercase" rows="3" placeholder="Descripción Completa" maxlength="1000"></textarea>
                            </div>
                        </section>
                    </div>
